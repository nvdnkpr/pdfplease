...
function PDFPlease (markdown, resultFile, cssFile, htmlContainerFile) {
    
    this._markdown = markdown || '';
    this._resultFile = resultFile || '';
    this._cssFile = cssFile || path.resolve(__dirname, '..', 'phantomjs', 'default.css');
    this._htmlContainerFile = htmlContainerFile || path.resolve(__dirname, '..', 'phantomjs', 'container.html');
    this._html = null;
...
/* PDFPlease.htmlContainer getter setter */
Object.defineProperty(PDFPlease.prototype, "htmlContainerFile", {

    get: function () {
        return this._htmlContainerFile;
    },
    
    set: function (htmlContainerFile) {
        this._htmlContainerFile = htmlContainerFile;
    }
...
module.exports.generatePDF = function (markdown, options, callback) {
    ...
    if (opts.htmlContainer) pdfp.htmlContainerFile = opts.htmlContainer;
